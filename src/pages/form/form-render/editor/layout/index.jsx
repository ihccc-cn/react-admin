...
function Layout({ top, left, right, children, style }) {
  return (
    <div className="form-editor-layout" style={style}>
      {left && <div className="form-editor-layout-side form-editor-layout-side-left">{left}</div>}
      ...
      {right && <div className="form-editor-layout-side form-editor-layout-side-right">{right}</div>}
    </div>
  );
}
